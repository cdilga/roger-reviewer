...
description: Use when operating Roger's local review cockpit (rr open / rr tui) and you need the exact keys and screens — Home/finder, Picker, SessionHome, Findings triage, Drafts approve/edit, Timeline, Search, and the help overlay. No aspirational keys, only what packages/tui actually implements.
---
