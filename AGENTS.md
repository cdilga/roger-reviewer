...
| [`docs/ENVIRONMENT_ALIGNMENT_AND_NEXT_ITERATION_PLAN.md`](docs/ENVIRONMENT_ALIGNMENT_AND_NEXT_ITERATION_PLAN.md) | Active launch-gate plan for aligning local/devbox environment truth, Agent Mail, NTM, Git, and beads before the next recovery implementation iteration |
